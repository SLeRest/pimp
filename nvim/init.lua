...
vim.keymap.set('n', '<leader>x', '<cmd>x<CR>', { desc = 'Quit and save buffer' })
vim.keymap.set('n', '<leader>c', '<cmd>bd!<CR>', { desc = 'Quit buffer' })
...
require('lazy').setup({
  ...
  -- TODO: setup comment code with <leader>/ in visual mode https://github.com/numToStr/Comment.nvim
  {
...
-- TODO: little tricks for making gofumpt formatting golang file
...
-- NOTE: comment visula mode with <leader>/
